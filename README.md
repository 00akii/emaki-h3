...
- **ComfyUI が VRAM を抱えたまま（H3 の重み常駐・約9GB）だと LLM は 35秒/本。** ComfyUI 停止時は **15〜30秒**（ブリーフの長さで変わる。短い4欄で15秒台、長いと30秒近く。2026-08-24 に別セッションが 22〜28秒を実測）。ヘッダーの GPU 表示と注意書きで分かるようにしてある
