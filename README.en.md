...
- **If you notice a rights infringement or license concern, please report it via [docs/REPORTING.en.md](docs/REPORTING.en.md).** Use a GitHub Issue for anything you're fine making public, or private reporting (the "Report a vulnerability" button under the Security tab) for anything you're not.
